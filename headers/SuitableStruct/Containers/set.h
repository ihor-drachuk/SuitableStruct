...
struct SuitableStruct::ContainerInserter<std::set<Args...>>
{
    using C = std::set<Args...>;
...
template<typename... Args> struct SuitableStruct::IsContainer<std::set<Args...>> : public std::true_type { };
