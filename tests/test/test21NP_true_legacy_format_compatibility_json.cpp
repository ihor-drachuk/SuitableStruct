...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_SerializeStructures)
{
    // Test data for v0
    ...
    const auto v0_json = ssJsonSave(v0_value, false);
    const auto v1_json = ssJsonSave(v1_value, false);
    const auto v2_json = ssJsonSave(v2_value, false);
...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_LoadJson_v0_to_v0)
{
    const QJsonValue legacyJson = QJsonDocument::fromJson(legacyJsonData_v0).object();
    ComplexStruct_v0 loaded;
    ssJsonLoad(legacyJson, loaded, SuitableStruct::SSLoadMode::NonProtectedF0Hint);
...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_LoadJson_v1_to_v0_ShouldFail)
{
    ...
    EXPECT_THROW(ssJsonLoad(legacyJson, loaded, SuitableStruct::SSLoadMode::NonProtectedF0Hint), std::exception);
}

// From legacy JSON, data v0 -> v1 (upgrade)
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_LoadJson_v0_to_v1)
{
    const QJsonValue legacyJson = QJsonDocument::fromJson(legacyJsonData_v0).object();
...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_LoadJson_v1_to_v1)
{
    const QJsonValue legacyJson = QJsonDocument::fromJson(legacyJsonData_v1).object();
    ComplexStruct_v1 loaded;
    ssJsonLoad(legacyJson, loaded, SuitableStruct::SSLoadMode::NonProtectedF0Hint);
...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_LoadJson_v0_to_v2)
{
    const QJsonValue legacyJson = QJsonDocument::fromJson(legacyJsonData_v0).object();
...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_LoadJson_v1_to_v2)
{
    const QJsonValue legacyJson = QJsonDocument::fromJson(legacyJsonData_v1).object();
    ComplexStruct_v2 loaded;
    ssJsonLoad(legacyJson, loaded, SuitableStruct::SSLoadMode::NonProtectedF0Hint);
...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_LoadJson_v2_to_v2)
{
...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_LoadJson_v2_to_v0_ShouldFail)
{
    const QJsonValue legacyJson = QJsonDocument::fromJson(legacyJsonData_v2).object();
    ComplexStruct_v0 loaded;
    EXPECT_THROW(ssJsonLoad(legacyJson, loaded, SuitableStruct::SSLoadMode::NonProtectedF0Hint), std::exception);
...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_LoadJson_v2_to_v1_ShouldFail)
{
    const QJsonValue legacyJson = QJsonDocument::fromJson(legacyJsonData_v2).object();
    ComplexStruct_v1 loaded;
    EXPECT_THROW(ssJsonLoad(legacyJson, loaded, SuitableStruct::SSLoadMode::NonProtectedF0Hint), std::exception);
...
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_CurrentFormat)
{
    ...
    const auto jsonVal = ssJsonSave(original, false);
    ComplexStruct_v2 loaded;
    ssJsonLoad(jsonVal, loaded, SuitableStruct::SSLoadMode::NonProtectedF1Hint);
    ASSERT_EQ(original, loaded);
}

// Test version downgrade compatibility (JSON)
TEST(SuitableStruct, JsonLegacyFormatF0CompatibilityTest_NP_VersionDowngrade)
{
    ComplexStruct_v2 v2;
    v2.intField = 42;
    v2.floatField = 3.14f;
    ...
    const auto json_v2 = ssJsonSave(v2, false);
    ComplexStruct_v1 v1;
    ssJsonLoad(json_v2, v1, SuitableStruct::SSLoadMode::NonProtectedF1Hint); // Uses ssDowngradeTo for ComplexStruct_v2 -> ComplexStruct_v1
    ...
    const auto json_v1 = ssJsonSave(v1, false);
    ComplexStruct_v0 v0;
    ssJsonLoad(json_v1, v0, SuitableStruct::SSLoadMode::NonProtectedF1Hint); // Uses ssDowngradeTo for ComplexStruct_v1 -> ComplexStruct_v0
...
#endif // !defined(GENERATE_MODE) && defined(FORMAT_HINT_SUPPORTED)
